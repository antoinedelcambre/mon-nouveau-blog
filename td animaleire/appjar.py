...
#####################################
    def __init__(
        ...
        # location of appJar
        self.resource_path = os.path.join(gui.lib_path, "../../../Downloads/appJar/resources")
...
###############################################################
    ...
    def _loadExternalDnd(self):
        ...
        if EXTERNAL_DND is None:
            try:
                tkdndlib = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../../Downloads/appJar/lib", "tkdnd2.8")
